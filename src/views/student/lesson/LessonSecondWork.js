...
function LessonSecondWork() {
    const { lesson } = useParams();
    const link = "/study/secondboard/" + lesson;

    return (
        <>
            <StudentNavBar />
            <br />
            <h2 className="text-center">บทที่ {lesson} ใบงานครั้งที่ 2</h2>
                ...
                <TabContent>
                    <Row>
                        <Col className="text-center">
                            <img
                                src={require("assets/img/worksheet/01/2.png").default}
                                alt="..."
...
export default LessonSecondWork;
